...
class AutoRetrainService:
    ...
    def _deploy_decision(self, baseline: Dict[str, Any], candidate: Dict[str, Any], force: bool) -> Dict[str, Any]:
        ...
        recall_guard_cfg = [
            ...
            ("next_likely_pain_group", "call_buyers", 25, 0.18, max(self.max_core_drop * 2.0, 0.08)),
            ("next_likely_pain_group", "put_buyers", 25, 0.18, max(self.max_core_drop * 2.0, 0.08)),
            ("next_likely_pain_group", "call_sellers", 25, 0.18, max(self.max_core_drop * 2.0, 0.08)),
            ("next_likely_pain_group", "put_sellers", 25, 0.18, max(self.max_core_drop * 2.0, 0.08)),
